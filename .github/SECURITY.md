...
Replace all {{PLACEHOLDER}} values with your information:
  lustreiser     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  lustreiser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/lustreiser/security/advisories/new)
...
- This repository (`hyperpolymath/lustreiser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/lustreiser/security/advisories)
...
When using lustreiser, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/lustreiser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/lustreiser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/lustreiser/discussions) |
...
*Thank you for helping keep lustreiser and its users safe.* 🛡️
